...
func _process(delta):
	...
	if _time_since_shot >= shoot_cooldown:
		...
		# spawn projectile
		var projectile_scene: PackedScene = preload("res://Scenes/TowerScene/Entities/projectile.tscn")
...
func take_damage_from_enemy(amount: int):
	var hit_particle_scene: PackedScene = preload("res://Scenes/TowerScene/Entities/hit_particle.tscn")
