...
#var enemy_scene: PackedScene = preload("res://Scenes/TowerScene/Entities/enemy.tscn")
...
func _ready():
	...
	var enemy_scene2: PackedScene = preload("res://Scenes/TowerScene/Entities/enemy_flyer.tscn")
